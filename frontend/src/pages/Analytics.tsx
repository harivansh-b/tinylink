...
export default function Analytics({ urlId }: AnalyticsPageProps) {
    ...
    // Derive top referrer from the list
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-[var(--fg-muted)] mt-0.5">
                        {urlId ? `Insights for ${analytics?.shortCode ?? "this link"}` : "Select a link to view analytics"}
                    </p>
                </div>
            ...
            {!urlId ? (
                <EmptyState
                    ...
                    description="Choose a link from your links page to view its analytics."
                />
            ) : loading ? (
